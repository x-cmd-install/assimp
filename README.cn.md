...
[![x-cmd/install — assimp Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/assimp.svg?lang=zh)](https://x-cmd.com/install/assimp)
...
合计: **651,839** 行代码（覆盖前 5 种语言、共 **1508** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Cpp | 213,479 | 53,126 | 39,149 | 743 |
...
- **Star**: 13,220 · **Fork**: 3,247 · **开放 issue**: 3,388 · **贡献者**: 701

## 累计统计

- **发布数**: 39 · **已合并 PR**: 2832 · **开放 PR**: 74 · **已关闭 issue**: 2907 · **开放 issue**: 481 · **提交数**: 12986

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-26 | 0 | 20 | 32 | 2 | 5 | 67 |
| last60d | 2026-07-27 | 0 | 43 | 45 | 10 | 24 | 119 |
| 90d | 2026-06-27 | 0 | 60 | 58 | 13 | 24 | 153 |
| last180d | 2026-03-29 | 1 | 120 | 72 | 32 | 47 | 245 |
| 360d | 2025-09-30 | 3 | 208 | 73 | 66 | 133 | 383 |
| last720d | 2024-10-05 | 6 | 421 | 74 | 224 | 258 | 443 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/assimp.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260925.yml` · 2026-09-25T05:05:45Z._
